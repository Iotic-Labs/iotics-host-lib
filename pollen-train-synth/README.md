...
```python
    def create_follower_twin(self):
        twin_id, _, _ = self.agent_auth.make_twin_id('PollenTrainSynthesiser')
...
As an example of how this configuration works, you can change this `update_frequency_seconds` value from its default of 300, by setting the environment variable `POLLENTRAINSYNTH_UPDATE_FREQUENCY_SECONDS`
e.g. to set it to 10 seconds: `export POLLENTRAINSYNTH_UPDATE_FREQUENCY_SECONDS=10`
