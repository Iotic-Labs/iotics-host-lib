...
As an example of how this configuration works, you can change this `update_frequency_seconds` value from its default of 300, by setting the environment variable `CALLAPI_UPDATE_FREQUENCY_SECONDS`
e.g. to set it to 10 seconds: `export CALLAPI_UPDATE_FREQUENCY_SECONDS=10`
