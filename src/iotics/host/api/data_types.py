...
class BasicDataTypes(Enum):
    ...
    Example: "2004-10-31T21:40:35.5-07:00" is a time on Halloween 2004 in Mountain Standard time.
    The equivalent UTC would be "2004-11-01T04:40:35.5Z".
    """
    DECIMAL = 'decimal'
    """Any base-10 fixed-point number. There must be at least one digit to the left of the decimal point,
    and a leading "+" or "-" sign is allowed.
    Examples: "42", "-3.14159", "+0.004".
    """
    DOUBLE = 'double'
    """A 64-bit floating-point decimal number as specified in the IEEE 754-1985 standard.
    The external form is the same as the float datatype.
    """
    FLOAT = 'float'
    ...
    Derived from the long datatype."""
    INTEGER = 'integer'
    """Represents a signed integer. Values may begin with an optional "+" or "-" sign.
    Derived from the decimal datatype."""
    LONG = 'long'
